...
declare class RoomManager {
  public sources(roomName: string, refresh?: boolean): SourceMemory[];
  public containers(roomName: string, refresh?: boolean): ContainerMemory[];
  public links(roomName: string, refresh?: boolean): LinkMemory[];
  public towers(roomName: string, refresh?: boolean): TowerMemory[]
